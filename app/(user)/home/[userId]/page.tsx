...
const Home = ({ params }: { params: Promise<{ userId: string }> }) => {
  ...
  const renderServiceIcon = (iconName: string) => {
    ...
    switch (iconName) {
      case "group":
        return <MdGroups {...props} />;
      case "group-add":
        return <MdAddBox {...props} />;
      case "book":
        return <MdMenuBook {...props} />;
      case "bar-chart":
        return <MdBarChart {...props} />;
      case "payment":
        return <MdPayments {...props} />;
      case "gavel":
        return <MdGavel {...props} />;
      case "wallet":
        return <MdAccountBalanceWallet {...props} />;
      case "person-add":
        return <MdPersonAdd {...props} />;
      case "rupee":
        return <MdCurrencyRupee {...props} />;
      default:
  ...
  const handleWhatsAppPress = () => {
    const whatsappUrl = `https://wa.me/919483900777?text=${encodeURIComponent(
      "Hello, I need assistance with MyChits App."
    )}`;
  ...
  const menuItems = [
    {
      title: "About Us",
      icon: "info",
      link: "https://www.mychits.co.in/about-us",
    },
    {
      title: "Privacy Policy",
      icon: "privacy",
      link: "https://www.mychits.co.in/privacypolicy.php",
    },
    { title: "Help", icon: "help", link: "https://www.mychits.co.in/faqs" },
    { title: "F&Q", icon: "faq", link: "https://www.mychits.co.in/faqs" },
  ...
  const services: ServiceItem[] = [
    ...
    {
      navigateTo: `new-groups/${userId}`,
      screen: "EnrollScreenMain",
      icon: "group-add",
      title: "New Groups",
      bgColor: "#E3F2FD",
      iconBg: "#053B90",
    ...
    {
      navigateTo: `auctions/${userId}`,
      icon: "gavel",
      title: "Auction",
      bgColor: "#F1F8E9",
      iconBg: "#558B2F",
      disabled: false,
      featureTitle: "Auction",
    },
    {
      navigateTo: `my-loan/${userId}`,
      screen: "MyLoan",
      icon: "wallet",
      title: "My Loan",
      bgColor: "#EDE7F6",
    ...
    {
      navigateTo: `pay-your-dues/${userId}`,
      icon: "rupee",
      title: "Pay Your Dues",
      bgColor: "#FFEBEE",
      iconBg: "#B71C1C",
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <header className="sticky top-0 z-40 bg-[#053B90] text-white shadow-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-8 font-semibold text-sm uppercase tracking-wide">
            ...
            <button
              onClick={() => router.push(`/new-groups/${userId}`)}
              className="hover:text-blue-300 transition-colors">
              New Groups
            </button>
            <button
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10 space-y-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {services.map((item, idx) => (
              <button
                key={idx}
                onClick={() =>
                  !item.disabled && router.push(`/${item.navigateTo}`)
                }
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div
              key={i}
              className="bg-white p-6 rounded-[2rem] border border-slate-200 shadow-sm transition-all hover:shadow-lg">
        ...
        <footer className="pt-10 pb-20 border-t border-slate-200 text-center space-y-6">
          <button
            ...
            className="inline-flex items-center gap-2 text-blue-600 font-bold hover:underline transition-all group">
          ...
          <div className="flex flex-col items-center gap-2">
            <p className="text-slate-400 text-sm flex items-center gap-2">
              Made with <FaHeart className="text-rose-500 animate-pulse" /> in
              India
            </p>
            <p className="text-slate-400 text-xs font-medium uppercase tracking-widest">
              © 2025 MyChits. All rights reserved.
            </p>
          </div>
        </footer>
      </main>
          ...
          <div className="relative w-80 max-w-[85%] bg-white h-full shadow-2xl animate-slideInLeft flex flex-col">
            ...
            <nav className="flex-1 px-4 py-6 space-y-2">
              ...
              <button
                ...
                className="w-full flex items-center gap-4 p-4 rounded-xl font-bold text-rose-500 hover:bg-rose-50 transition-colors">
      ...
      {isHelpModalVisible && (
        <div
          ...
          <div
            className="bg-white w-full max-w-md rounded-[2.5rem] p-8 shadow-2xl animate-slideUp flex flex-col"
            ...
            <div className="mt-10 text-center bg-blue-50 p-6 rounded-[2rem]">
              ...
              <button
                ...
                className="w-full bg-[#053B90] text-white py-4 rounded-2xl font-black flex items-center justify-center gap-3 shadow-lg shadow-blue-200 hover:bg-blue-800 transition-all">
                <IoCall size={20} />
                Call 9483900777
              </button>
            </div>
